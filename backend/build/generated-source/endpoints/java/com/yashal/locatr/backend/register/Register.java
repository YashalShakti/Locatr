 ...
 * on 2016-04-16 at 21:00:06 UTC 
 * Modify at your own risk.
 */

package com.yashal.locatr.backend.register;
...
public class Register extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://the-locatr.appspot.com/_ah/api/";
  ...
  public class ListDevices extends RegisterRequest<com.yashal.locatr.backend.register.model.CollectionResponseRegistrationRecord> {
    ...
    protected ListDevices(java.lang.Integer count) {
      super(Register.this, "GET", REST_PATH, null, com.yashal.locatr.backend.register.model.CollectionResponseRegistrationRecord.class);
   ...
   * @return the request
   */
  public RegisterOperation register(java.lang.String regId) throws java.io.IOException {
    RegisterOperation result = new RegisterOperation(regId);
    initialize(result);
    return result;
  }
  ...
  public class RegisterOperation extends RegisterRequest<Void> {
     ...
     * @since 1.13
     */
    protected RegisterOperation(java.lang.String regId) {
  ...
  public class Unregister extends RegisterRequest<Void> {
